...
import type { AnalysisId as _AnalysisId, AnalysisInput as _AnalysisInput, AnalysisRecord as _AnalysisRecord, ExternalBlob as _ExternalBlob, Modality as _Modality, Quality as _Quality, Time as _Time, TriageStatus as _TriageStatus, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAnalysis(arg0: AnalysisId): Promise<AnalysisRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.getAnalysis(arg0);
                return from_candid_AnalysisRecord_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getMyAnalyses(): Promise<Array<AnalysisRecord>> {
        if (this.processError) {
            try {
    ...
    async submitAnalysis(arg0: AnalysisInput): Promise<AnalysisId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAnalysis(await to_candid_AnalysisInput_n23(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async timeToText(arg0: Time): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.timeToText(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AnalysisRecord_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnalysisRecord): Promise<AnalysisRecord> {
...
function from_candid_Modality_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Modality): Modality {
    return from_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function from_candid_Quality_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Quality): Quality {
    return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_TriageStatus_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TriageStatus): TriageStatus {
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "good" in value ? Quality.good : "poor" in value ? Quality.poor : value;
}
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ct" in value ? Modality.ct : "mri" in value ? Modality.mri : value;
}
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "normal" in value ? TriageStatus.normal : "critical" in value ? TriageStatus.critical : value;
}
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AnalysisRecord>): Promise<Array<AnalysisRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AnalysisRecord_n10(_uploadFile, _downloadFile, x)));
}
async function to_candid_AnalysisInput_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisInput): Promise<_AnalysisInput> {
...
function to_candid_Modality_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Modality): _Modality {
    return to_candid_variant_n28(_uploadFile, _downloadFile, value);
}
function to_candid_Quality_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Quality): _Quality {
    return to_candid_variant_n26(_uploadFile, _downloadFile, value);
}
function to_candid_TriageStatus_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TriageStatus): _TriageStatus {
...
function to_candid_variant_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Quality): {
    good: null;
} | {
    poor: null;
} {
...
function to_candid_variant_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Modality): {
    ct: null;
} | {
    mri: null;
} {
    return value == Modality.ct ? {
        ct: null
    } : value == Modality.mri ? {
        mri: null
    } : value;
}
function to_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TriageStatus): {
    normal: null;
} | {
    critical: null;
} {
    return value == TriageStatus.normal ? {
        normal: null
    } : value == TriageStatus.critical ? {
        critical: null
    } : value;
}
